...
-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'COMPLETED', 'SHIPPED', 'DELIVERED');
...
CREATE TABLE "Product" (
    ...
    "meiliIndexed" BOOLEAN NOT NULL DEFAULT false,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "Collection" (
    ...
    "coverImage" TEXT,
    "artisanId" TEXT NOT NULL,
    "isAiCurated" BOOLEAN NOT NULL DEFAULT false,
...
-- AddForeignKey
ALTER TABLE "Collection" ADD CONSTRAINT "Collection_artisanId_fkey" FOREIGN KEY ("artisanId") REFERENCES "ArtisanProfile"("id") ON DELETE CASCADE ON UPDATE CASCADE;
